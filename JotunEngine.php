...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="body-text">The Jotun Engine was begun in spring 2013 as an end-of-year project for my AP Computer Science class. Although I had messed around with OpenGL before, this was the first time I tried to make an actual engine out of it. The engine was developed concurrently with a game entitled <a href="https://github.com/DethRaid/AGameWithGod">"A Game With God"</a>. After the game's completion, the Jotun Engine allowed one to render meshes using GLSL shaders. However, lighitng was not yet implemented, nor was any sort of shadowing algorithm. At this point, the engine can be said to be in version 0.1.</p>
            <div class="panel panel-default pull-right">
                <div class="panel-body">
                    <img src="img/AGameWithGod.png" class="img-responsive">
                </div>
            </div>
            ...
            <p>During the summer of 2013, the Jotun Engine was upgraded to version 0.15. The version number change represents a re-organization of internal data into a much more coherent format. The engine created a list of loaded assets, then refrenced those assets at runtime, sometimes referencing a single asset many times. This was done to save memory.</p>
             <div class="panel panel-default pull-left">
                <div class="panel-body">
                    <img src="img/GameJam2013.png" class="img-responsive">
                </div>
            </div>
            <p>The Jotun Engine 0.15 reached its pinnacle during a game jam hosted by the Rochester Institute of Technology's Computer Science House in the fall of 2013. During that game jam, I developed a game where one sent missiles from the sky into an ever-growing swarm of suited enemies. This game can be found <a href="https://github.com/DethRaid/GameJam2013">here</a>. The engine included uses the asset lists mentioned above, in addition to better scene management, sound playback through a single audio channel (hacked in last-minute), and basic cutscene functionality. However, realtime lighting was still absent, and the Jotun Engine still relied on the OpenGL 1.1 API.</p>
             <div class="panel panel-default pull-right">
                <div class="panel-body">
                    <img src="img/PCSSEx.png" class="img-responsive">
                </div>
            </div>
            <p>Enter the Jotun Engine 0.2. This version of the engine, completely re-written, included a number of features its predecessors could never hope to have. It used the OpenGL 2.1 API, with fun features such as Vertex Buffer Obejcts for improved performance. It supported real-time lighting from a single colored directional light, normal mapping, shadow mapping with either a point filter, a percentage-closer filter, or a <a href="http://developer.download.nvidia.com/shaderlibrary/docs/shadow_PCSS.pdf">varying-width percentage closer filter</a>. It also had a rudamentery snow system, inspired by The Elder Scrolls V: Skyrim.</p>
